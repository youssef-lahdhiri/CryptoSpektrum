...
const CoinList = ({ coins }) =>{ 
    const coinContainer=useRef()
    const scrollLeft=()=>{
      coinContainer.current.scrollLeft-=200;
    }
    const scrollRight=()=>{
      coinContainer.current.scrollLeft+=200;
    }
  ...
  <div ref={coinContainer} className='  h-18 scroll-smooth z-0 relative m-5 ml-0 w-full grid grid-flow-col gap-3  overflow-auto md:overflow-hidden'>
